...
bp = st.radio("Do you have blood pressure problems?", ["No", "Yes"])
transplants = st.radio("Have you had any organ transplants?", ["No", "Yes"])
chronic = st.radio("Do you have any chronic diseases?", ["No", "Yes"])
...
allergies = st.radio("Do you have any known allergies?", ["No", "Yes"])
cancer_history = st.radio("Is there a family history of cancer?", ["No", "Yes"])
...
if st.button("💡 Predict Premium"):
    ...
    try: 
        response = requests.post("https://github.com/imaduhu1/PremiumPredictionFastAPI.com/predict_premium/", json=payload)
